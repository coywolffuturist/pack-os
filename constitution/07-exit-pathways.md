...
A Pack Exchange purchase transfers an existing seat and mints nothing, so the seat count does not change and no Liveness Check arises. A replacement mint, issued only after a Phase 3 Legacy conversion, bypasses the Liveness Check (Part III §7): it restores the 1,000-seat cap rather than expanding it.
